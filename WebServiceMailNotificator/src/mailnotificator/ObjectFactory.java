 ...
 * generated in the mailnotificator package. 
...
public class ObjectFactory {
    ...
    private final static QName _Notify_QNAME = new QName("http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", "notify");
    private final static QName _GetPrice_QNAME = new QName("http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", "getPrice");
    private final static QName _NotifyResponse_QNAME = new QName("http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", "notifyResponse");
    private final static QName _GetPriceResponse_QNAME = new QName("http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", "getPriceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mailnotificator
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", name = "notify")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", name = "getPrice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", name = "notifyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pis.predmety.fiit.stuba.sk/pis/notificationservices/mail/types", name = "getPriceResponse")
